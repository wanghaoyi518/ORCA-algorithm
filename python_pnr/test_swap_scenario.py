#!/usr/bin/env python3
"""
Test scenario with more space for swap operations
"""
...
def create_swap_scenario():
    """Create a scenario with more space for swap operations"""
    # 5x5 grid with more space
    grid = [
        [1, 1, 1, 1, 1],
        [1, 0, 0, 0, 1],
        [1, 0, 0, 0, 1],
    ...
    # Actor 0: start at (1,1), goal at (3,3)
    actor0 = Actor(0, Point(1, 1), Point(3, 3))
    actors.append(actor0)
    
    # Actor 1: start at (3,3), goal at (1,1)
    actor1 = Actor(1, Point(3, 3), Point(1, 1))
...
def test_swap_functionality():
    ...
    print("Testing swap functionality with more space...")
